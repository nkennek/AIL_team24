...
from net_so import *
from updater_so import Updater
from visualize_so import out_generated_image
...
def main():
    ...
    parser.add_argument('--pretrain', '-p', default='pre_result',
    ...
    if args.pretrain:
        chainer.serializers.load_npz(args.pretrain + "/encoder_iter_2000.npz", encoder)
        chainer.serializers.load_npz(args.pretrain + "/decoder_iter_2000.npz", decoder)
    ...
    updater = Updater(
        ...
        iterator=train_iter,
        optimizer={
            "encoder": opt_encoder, "decoder": opt_decoder},
        device=args.gpu)
    ...
    trainer.extend(extensions.PrintReport([
        'epoch', 'iteration', 'decoder/loss', 'encoder/loss',
